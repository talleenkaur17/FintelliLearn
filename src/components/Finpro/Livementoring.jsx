...
const MentorDescription = ({
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-lg p-6 md:w-1/2 border border-gray-200 flex flex-col items-center transition-all duration-300 ${
        showDetails ? "max-h-screen" : "max-h-96"
      }`}
    >
