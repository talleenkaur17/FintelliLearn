...
const Goodies = () => {
  ...
  const items = [
    {
      ...
      image: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718387924/sweatimage_vqw1wr.jpg',
      points: 150,
    ...
    },
    {
      title: 'Mug',
      description: 'Avail this now!',
      image: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718388296/mug_vnswqy.avif',
      points: 200,
      gif: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718276712/coin_a758dr.gif',
    },
    {
      title: 'Bag',
      description: 'Avail this now!',
      image: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718388392/bag_fomymg.jpg',
      points: 300,
      gif: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718276712/coin_a758dr.gif',
    },
    {
      ...
      description: 'Avail this now!',
      image: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718388483/stickers_mekzzu.jpg',
      points: 400,
      gif: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718276712/coin_a758dr.gif',
    },
    {
      title: 'Keychain',
      description: 'Avail this now!',
      image: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718388586/key_r5t2if.jpg',
      points: 500,
      gif: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718276712/coin_a758dr.gif',
    },
    {
      title: 'Shoes',
      description: 'Avail this now!',
      image: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718276592/cld-sample-5.jpg',
      points: 600,
      gif: 'https://res.cloudinary.com/duu6ej0qx/image/upload/v1718276712/coin_a758dr.gif',
    },
  ];
  ...
  return (
    <div className="container mx-auto py-8">
      <h2 className="text-3xl font-bold text-center mt-8 mb-6">Explore Our Goodies</h2>
          ...
          <div key={index} className="relative rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
              <div className="text-center text-white z-10 p-4">
                ...
                <button className="bg-blue-500 text-white py-2 px-4 mt-2 rounded hover:bg-blue-600 focus:outline-none">Add</button>
              </div>
            </div>
          </div>
        ))}
